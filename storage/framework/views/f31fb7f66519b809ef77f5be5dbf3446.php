                ...
                <div class="card custom-card my-4 border z-3 position-relative">
                    <div class="card-body p-0">
                        <div class="p-5">
                            ...
                            <form class="mt-4" method="POST" action="<?php echo e(route('login.post')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                ...
                                <div class="text-center mb-0">
                                    <p class="text-muted mt-3 mb-0">Dont have an account? <a
                                            href="<?php echo e(route('register.get')); ?>" class="text-primary">Sign Up</a></p>
                                </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.authentication', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MMP\resources\views/auth/login.blade.php ENDPATH**/ ?>