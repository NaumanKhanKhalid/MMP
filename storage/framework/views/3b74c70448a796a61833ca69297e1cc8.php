    ...
    <script>
        ...
        function printProducts() {
            try {
                ...
                const totalProducts = <?php echo e($products->total()); ?>;
                const activeProducts = <?php echo e($products->where('status', 'active')->count()); ?>;
                const inactiveProducts = <?php echo e($products->where('status', 'inactive')->count()); ?>;
                    ...
                    <tbody>
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end cost">R <?php echo e(number_format($lastCost, 2)); ?></td>
                                <td class="text-end badge-stock"><?php echo e(number_format($totalStock, 2)); ?></td>
                                <td class="text-end price">R <?php echo e(number_format($product->normal_price, 2)); ?></td>
                                <td class="text-end price">R <?php echo e(number_format($product->online_price, 2)); ?></td>
                                <td class="text-end price">R <?php echo e(number_format($product->workshop_price, 2)); ?></td>
                                <td>
                                    <?php if($product->oeNumbers->count() > 0): ?>
                                        <?php echo e($product->oeNumbers->take(2)->pluck('oe_number')->implode(', ')); ?>

                                        <?php if($product->oeNumbers->count() > 2): ?>
                                            <br><small>+<?php echo e($product->oeNumbers->count() - 2); ?> more</small>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                ...
                                <td>
                                    <?php if($product->crossRefs->count() > 0): ?>
                                        <?php echo e($product->crossRefs->take(2)->pluck('cross_ref_number')->implode(', ')); ?>

                                        <?php if($product->crossRefs->count() > 2): ?>
                                            <br><small>+<?php echo e($product->crossRefs->count() - 2); ?> more</small>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($product->bin_location ?: '-'); ?></td>
                                <td class="text-center">
                                    <span class="badge <?php echo e($product->status === 'active' ? 'badge-active' : 'badge-inactive'); ?>">
                    ...
                    <div class="row g-2">
                        <div class="col-md-3">
                            <input type="text" name="search" id="searchInput" class="form-control"
                                placeholder="Search: Name, SKU, Description, OE#, Supplier Code, Brand Code, Bin..." value="<?php echo e(request('search')); ?>">
                        </div>
                        <div class="col-md-2">
                            ...
                            <select name="category_id" id="categoryFilter" class="form-select">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>"
                                        <?php echo e(request('category_id') == $c->id ? 'selected' : ''); ?>>
                                        <?php echo e($c->name); ?>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="card-title">
                        Products<span
                            class="badge bg-light text-default rounded ms-1 fs-12 align-middle"><?php echo e($products->total()); ?></span>
                    </div>
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('products.export', ['format' => 'pdf'])); ?>">
                                        <i class="ri-file-pdf-line me-2 text-danger"></i>Export as PDF
                                    </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('products.export', ['format' => 'csv'])); ?>">
            ...
            <div class="card-footer">
                <div id="paginationContainer">
                    <?php echo $__env->make('products.partials.pagination', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div> 
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function loadProductsForBarcode() {
            ...
            fetch(`<?php echo e(route('products.index')); ?>?ajax=1&search=${encodeURIComponent(search)}&category=${category}&status=${status}`, {
                headers: {
