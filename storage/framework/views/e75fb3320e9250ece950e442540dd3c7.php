...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="<?php echo e(route('dashboard')); ?>" class="header-logo">
            <img src="<?php echo e(url('public/assets/images/brand-logos/desktop-logo.png')); ?>" alt="logo" class="desktop-logo">
            <img src="<?php echo e(url('public/assets/images/brand-logos/toggle-dark.png')); ?>" alt="logo" class="toggle-dark">
            <img src="<?php echo e(url('public/assets/images/brand-logos/desktop-dark.png')); ?>" alt="logo"
                class="desktop-dark">
            <img src="<?php echo e(url('public/assets/images/brand-logos/toggle-logo.png')); ?>" alt="logo" class="toggle-logo">
        </a>
    </div>
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="<?php echo e(route('quotes.index')); ?>" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="20"
                            ...
                            <path d="M9 5h9a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H13l-4 4v-4H6a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3h3z"
                ...
                <li class="slide">
                    <a href="<?php echo e(route('purchase-orders.index')); ?>" class="side-menu__item <?php echo e(request()->routeIs('purchase-orders.*') ? 'active' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="20"
                            height="20" viewBox="0 0 24 24">
        ...
        <li class="slide has-sub">
            ...
            <ul class="slide-menu child2">
                <li><a href="<?php echo e(route('car-makes.index')); ?>"
                        class="side-menu__item <?php echo e(request()->routeIs('car-makes.*') ? 'active' : ''); ?>">Car Makes</a></li>
                <li><a href="<?php echo e(route('car-models.index')); ?>"
                        class="side-menu__item <?php echo e(request()->routeIs('car-models.*') ? 'active' : ''); ?>">Car Models</a></li>
