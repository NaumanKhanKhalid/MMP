<div class="modal fade" id="createJobCardModal" tabindex="-1" data-products='<?php echo json_encode($products, 15, 512) ?>'
     data-technicians='<?php echo json_encode($technicians, 15, 512) ?>'>
                                        ...
                                        <select class="form-select" id="customerSelect">
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->name); ?>"
                                                    ...
                                                    data-vehicle-make="<?php echo e($customer->vehicle_make); ?>"
                                                    data-vehicle-model="<?php echo e($customer->vehicle_model); ?>"
                                                    data-vehicle-vin="<?php echo e($customer->vehicle_vin); ?>"
                                                    data-vehicle-reg="<?php echo e($customer->vehicle_reg); ?>"
                                                    data-vehicle-mileage="<?php echo e($customer->vehicle_mileage); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="vehicleYear"
                                                    name="vehicle_year" min="1900" max="<?php echo e(date('Y')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-sm table-borderless mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-muted">VAT (<?php echo e($vatEnabled ? $vatRate : 0); ?>%):</td>
...
<?php /**PATH C:\xampp\htdocs\MMP\resources\views/job-cards/partials/create_modal.blade.php ENDPATH**/ ?>