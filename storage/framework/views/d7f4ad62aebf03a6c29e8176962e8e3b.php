...
<form action="<?php echo e(route('customers.update', $customer)); ?>" method="POST" id="customerEditForm">
    <?php echo csrf_field(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="customer_code" class="form-control" value="<?php echo e($customer->customer_code); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="customer_type" class="form-control" required id="editCustomerTypeSelect">
                            <option value="cash" <?php echo e($customer->customer_type === 'cash' ? 'selected' : ''); ?>>Cash Customer</option>
                            <option value="credit" <?php echo e($customer->customer_type === 'credit' ? 'selected' : ''); ?>>Credit Customer</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Category <span class="text-danger">*</span></label>
                        <select name="customer_category" class="form-control" required id="editCustomerCategorySelect">
                            <option value="individual" <?php echo e($customer->customer_category === 'individual' ? 'selected' : ''); ?>>Individual</option>
                            <option value="business" <?php echo e($customer->customer_category === 'business' ? 'selected' : ''); ?>>Business</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3" id="editCompanyNameField" style="display:<?php echo e($customer->customer_category === 'business' ? 'block' : 'none'); ?>;">
                        <label class="form-label fw-bold">Company Name</label>
                        <input type="text" name="company_name" class="form-control" value="<?php echo e($customer->company_name); ?>">
                    </div>
                    <div class="col-md-6 mb-3" id="editContactPersonField" style="display:<?php echo e($customer->customer_category === 'business' ? 'block' : 'none'); ?>;">
                        <label class="form-label fw-bold">Contact Person</label>
                        <input type="text" name="contact_person" class="form-control" value="<?php echo e($customer->contact_person); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="address" class="form-control" rows="2"><?php echo e($customer->address); ?></textarea>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="postal_code" class="form-control" value="<?php echo e($customer->postal_code); ?>">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Country</label>
                        <input type="text" name="country" class="form-control" value="<?php echo e($customer->country ?? 'South Africa'); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div id="vehiclesContainer">
                    ...
                    <?php $__currentLoopData = $customer->vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="vehicle-item border rounded p-3 mb-3" data-vehicle-id="<?php echo e($vehicle->id); ?>">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h6 class="mb-0 text-secondary"><i class="ri-car-line me-2"></i>Vehicle #<?php echo e($index + 1); ?></h6>
                            <button type="button" class="btn btn-sm btn-danger remove-existing-vehicle-btn" data-vehicle-id="<?php echo e($vehicle->id); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="existing_vehicles[<?php echo e($vehicle->id); ?>][make_id]" class="form-control existing-vehicle-make-select" data-vehicle-id="<?php echo e($vehicle->id); ?>" data-selected="<?php echo e($vehicle->make_id); ?>">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="existing_vehicles[<?php echo e($vehicle->id); ?>][model_id]" class="form-control existing-vehicle-model-select" data-vehicle-id="<?php echo e($vehicle->id); ?>" data-selected="<?php echo e($vehicle->model_id); ?>">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="existing_vehicles[<?php echo e($vehicle->id); ?>][engine]" class="form-control" value="<?php echo e($vehicle->engine ?? ''); ?>" placeholder="e.g. 2.0 Turbo">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Registration</label>
                                <input type="text" name="existing_vehicles[<?php echo e($vehicle->id); ?>][registration_number]" class="form-control" value="<?php echo e($vehicle->registration_number); ?>" placeholder="e.g. ABC123GP">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label fw-bold">VIN</label>
                                <input type="text" name="existing_vehicles[<?php echo e($vehicle->id); ?>][vin_number]" class="form-control" value="<?php echo e($vehicle->vin_number); ?>">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label fw-bold">Year</label>
                                <input type="text" name="existing_vehicles[<?php echo e($vehicle->id); ?>][year]" class="form-control" value="<?php echo e($vehicle->year); ?>" placeholder="e.g. 2020">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label fw-bold">Mileage</label>
                                <input type="text" name="existing_vehicles[<?php echo e($vehicle->id); ?>][mileage]" class="form-control" value="<?php echo e($vehicle->mileage); ?>" placeholder="e.g. 50000">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-check-label mt-4">
                                    <input type="checkbox" name="existing_vehicles[<?php echo e($vehicle->id); ?>][is_primary]" class="form-check-input" value="1" <?php echo e($vehicle->is_primary ? 'checked' : ''); ?>>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="terms" class="form-control" required id="editPaymentTermsSelect">
                            <option value="cash" <?php echo e($customer->terms === 'cash' ? 'selected' : ''); ?>>Cash</option>
                            <option value="on_account" <?php echo e($customer->terms === 'on_account' ? 'selected' : ''); ?>>On Account</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="price_tier" class="form-control" required>
                            <option value="normal" <?php echo e($customer->price_tier === 'normal' ? 'selected' : ''); ?>>Normal</option>
                            <option value="online" <?php echo e($customer->price_tier === 'online' ? 'selected' : ''); ?>>Online</option>
                            <option value="workshop" <?php echo e($customer->price_tier === 'workshop' ? 'selected' : ''); ?>>Workshop</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3" id="editCreditLimitField" style="display:<?php echo e($customer->customer_type === 'credit' ? 'block' : 'none'); ?>;">
                        <label class="form-label fw-bold">Credit Limit</label>
                        <div class="input-group">
                            <span class="input-group-text">R</span>
                            <input type="number" name="credit_limit" class="form-control" step="0.01" min="0" value="<?php echo e($customer->credit_limit); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="customer_status" class="form-control" required>
                            <option value="active" <?php echo e($customer->customer_status === 'active' ? 'selected' : ''); ?>>Active</option>
                            <option value="inactive" <?php echo e($customer->customer_status === 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                    </div>
...
$(document).ready(function() {
    let vehicleIndex = <?php echo e($customer->vehicles->count()); ?>;
    let deletedVehicles = [];
        ...
        $(`.existing-vehicle-make-select[data-vehicle-id="${vehicleId}"]`).select2({
            ...
            if (data.newTag) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: { _token: '<?php echo e(csrf_token()); ?>', name: makeName },
        ...
        $(`.existing-vehicle-model-select[data-vehicle-id="${vehicleId}"]`).select2({
            ...
            if (data.newTag) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: { _token: '<?php echo e(csrf_token()); ?>', name: modelName, make_id: makeId },
                    success: function(response) {
                        if (response.success) {
...
<?php /**PATH C:\xampp\htdocs\MMP\resources\views/customers/partials/edit_modal.blade.php ENDPATH**/ ?>