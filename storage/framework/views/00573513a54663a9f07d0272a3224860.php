...
<div class="modal-header bg-primary text-white">
    <h5 class="modal-title">
        <i class="ri-file-text-line me-2"></i> Goods Receipt Note #<?php echo e($grn->grn_number); ?>
        ...
        ?>
        <span class="badge <?php echo e($statusClass); ?> ms-2"><?php echo e(ucfirst($grn->status)); ?></span>
    </h5>
...
<div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td><?php echo e($grn->supplier->name ?? 'N/A'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-semibold">Email:</td>
                            <td><?php echo e($grn->supplier->email ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-semibold">Phone:</td>
                            <td><?php echo e($grn->supplier->phone ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="fw-semibold">Address:</td>
                            <td><?php echo e($grn->supplier->address ?? '-'); ?></td>
                        </tr>
                    </table>
                </div>
                        </div>
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td><span class="badge bg-primary"><?php echo e($grn->grn_number); ?></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="text-decoration-underline text-primary" 
                                   onclick="viewPO(<?php echo e($grn->purchaseOrder->id); ?>)">
                                    <?php echo e($grn->purchaseOrder->po_number); ?>

                                </a>
                                <span class="badge bg-info ms-2"><?php echo e(ucfirst($grn->purchaseOrder->status)); ?></span>
                            </td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                            <td class="fw-semibold">Created By:</td>
                            <td><?php echo e($grn->user->name ?? 'N/A'); ?></td>
                        </tr>
                        <?php if($grn->invoice_number): ?>
                        <tr>
                            <td class="fw-semibold">Invoice Number:</td>
                            <td><?php echo e($grn->invoice_number); ?></td>
                        </tr>
                        <?php endif; ?>
                    </table>
                </div>
    ...
    <div class="card border shadow-sm mb-3">
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-primary"><?php echo e($grn->items->count()); ?> items</span>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-light text-dark"><?php echo e($item->ordered_qty); ?></span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-success-transparent rounded-pill"><?php echo e($item->received_qty); ?></span>
                            </td>
                            <td class="text-end">R <?php echo e(number_format($item->unit_cost, 2)); ?></td>
                            <td class="text-end fw-semibold">R <?php echo e(number_format($item->line_total, 2)); ?></td>
                            </tr>
        ...
        <div class="col-md-7">
            ...
            <div class="card border shadow-sm h-100">
                <div class="card-header bg-secondary-transparent py-2">
                    ...
                    <div class="card-body">
                    <p class="mb-0"><?php echo e($grn->notes); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td class="text-end" width="120"><?php echo e($grn->items->count()); ?></td>
                        </tr>
                        <tr>
                            <td class="text-end fw-semibold">Total Quantity:</td>
                            <td class="text-end"><?php echo e($grn->items->sum('received_qty')); ?></td>
                        </tr>
                        <tr class="table-success">
                            <td class="text-end fw-bold fs-16">Grand Total:</td>
                            <td class="text-end fw-bold fs-16">R <?php echo e(number_format($grn->total_amount ?? 0, 2)); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" onclick="printGRNModal(<?php echo e($grn->id); ?>)">
...
function printGRNOld(grnId) {
    window.open('<?php echo e(route("goods-receipts.print", ":id")); ?>'.replace(':id', grnId), '_blank');
    return;
    
    const printWindow = window.open('', '_blank', 'width=1200,height=800');
    
    // Get GRN data
    const grnData = <?php echo json_encode($grn, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\MMP\resources\views/goods_receipts/partials/view_modal.blade.php ENDPATH**/ ?>