<?php $__env->startPush('styles'); ?>
    ...
    <script>
        ...
        function sendQuoteWhatsApp(quoteId) {
            ...
            const url = "<?php echo e(route('quotes.send-whatsapp', ':id')); ?>".replace(':id', quoteId);
        ...
        function sendQuoteEmail(quoteId) {
            ...
            const url = "<?php echo e(route('quotes.send-email', ':id')); ?>".replace(':id', quoteId);
        ...
        <div class="card shadow-sm">
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <?php if($quote->customer): ?>
                                                ...
                                                <span
                                                    class="badge badge-sm <?php echo e($quote->customer->terms === 'credit' ? 'bg-success-transparent text-success' : 'bg-warning-transparent text-warning'); ?>">
                                    ...
                                    <i class="ri-pencil-line"></i>
                                            ...
                                            <?php if(!$quote->converted_invoice_id && !in_array($quote->status, ['declined', 'cancelled'])): ?>
                                                <button type="button"
                                                    ...
                                                    title="Convert to Invoice" data-quote-id="<?php echo e($quote->id); ?>"
                                                    data-quote-total="<?php echo e($quote->grand_total ?? $quote->items->sum('total')); ?>">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        onclick="printQuote(<?php echo e($quote->id); ?>)">
                                                        <i class="ri-printer-line me-2"></i>Print Quote
                                                    </a>
                                                </li>
                                                <!-- Download PDF -->
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('quotes.pdf', $quote->id)); ?>"
                                                        target="_blank">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        onclick="sendQuoteWhatsApp(<?php echo e($quote->id); ?>)">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        onclick="sendQuoteEmail(<?php echo e($quote->id); ?>)">
            ...
            <div class="card-footer">
                <div id="paginationContainer">
                    <?php echo $__env->make('quotes.partials.pagination', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        function confirmQuotePayment(quoteId, quoteTotal) {
            ...
            const formData =
                `_token=<?php echo e(csrf_token()); ?>&payment_method=${paymentMethod}&amount_paid=${amountPaid}&payment_reference=${paymentReference}`;
