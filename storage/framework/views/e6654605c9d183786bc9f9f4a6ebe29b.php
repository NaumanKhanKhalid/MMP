        ...
        function confirmQuotePayment(quoteId, quoteTotal) {
            ...
            if (paymentMethod === 'credit') {
                ...
                if (quoteTotal > availableCredit) {
                    toastr.error(`Insufficient credit limit. Available: R ${availableCredit.toFixed(2)}, Required: R ${quoteTotal.toFixed(2)}`);
                    return;
                }
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        if (response.message.includes('insufficient stock')) {
                            ...
                            showPostSaleModal(response.invoice_id, response.invoice_number, response.grand_total || quoteTotal);
                        }
                    }
                },
                error: function(xhr) {
