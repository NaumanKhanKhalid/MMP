<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('customers.index')); ?>" id="customerSearchForm">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Search</label>
                            <input type="text" name="search" class="form-control" placeholder="Name, Code, Email, Phone..." value="<?php echo e(request('search')); ?>">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="category" class="form-control">
                                <option value="">All</option>
                                <option value="individual" <?php echo e(request('category') == 'individual' ? 'selected' : ''); ?>>Individual</option>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('customers.index')); ?>" class="btn btn-light">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-footer">
                <div id="paginationContainer">
                    <?php echo $__env->make('customers.partials.pagination', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
        ...
        <!-- Customer Modals -->
            ...
            <?php $__env->startPush('scripts'); ?>
                <script>
                    ...
                    let currentPage = <?php echo e($customers->currentPage()); ?>;
                    let isLoading = false;
                    ...
                    function loadCustomers() {
                        ...
                        $.get('<?php echo e(route("customers.index")); ?>', params, function(data) {
                    ...
                    $(function() {
                        ...
                        $('#openCreateCustomerModal').on('click', function() {
                            $.get("<?php echo e(route('customers.create')); ?>", function(html) {
                        ...
                        $(document).on('click', '.openViewCustomerModal', function() {
                            var id = $(this).data('id');
                            $.get("<?php echo e(route('customers.view-modal', ':id')); ?>".replace(':id', id), function(html) {
                                $('#customerModalContent').html(html);
                                $('#customerModal').modal('show');
                            });
                        });
                        ...
                        $(document).on('click', '.openEditCustomerModal', function() {
                            var id = $(this).data('id');
                            $.get("<?php echo e(route('customers.edit-modal', ':id')); ?>".replace(':id', id), function(html) {
                                $('#customerModalContent').html(html);
                                $('#customerModal').modal('show');
                            });
                        });
                        ...
                        $(document).on('click', '.openDeleteCustomerModal', function(e) {
                            ...
                            $('#deleteCustomerForm').attr('action', "<?php echo e(route('customers.destroy', ':id')); ?>".replace(':id', id));
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MMP\resources\views/customers/index.blade.php ENDPATH**/ ?>