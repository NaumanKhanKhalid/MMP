                    ...
                    <div class="row g-2 mb-2">
                        ...
                        <div class="col-6">
                            <label class="form-label small mb-1">
                                ...
                                <span class="badge <?php echo e($vatSettings['inclusive'] ? 'bg-info' : 'bg-warning'); ?> badge-sm">
                                    <?php echo e($vatSettings['inclusive'] ? 'Inc' : 'Exc'); ?>
...
let vatInclusive = <?php echo e($vatSettings['inclusive'] ? 'true' : 'false'); ?>;
...
$(document).ready(function() {
    // VAT already initialized via Blade (checked="<?php echo e($vatSettings['enabled'] ? 'checked' : ''); ?>")
    ...
    .then(data => {
        if (data.success) {
            ...
            $('#viewQuotationBtn').off('click').on('click', function() {
                const url = '<?php echo e(route('quotes.index')); ?>?search=' + encodeURIComponent(quoteNumber);
