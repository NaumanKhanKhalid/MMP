            ...
            <div class="card-body">
                        ...
                        <select name="supplier_id" id="createSupplier" class="form-select" required>
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" 
                                        ...
                                        data-lead-time="{{ $supplier->lead_time ?? 0 }}">
                                    {{ $supplier->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    {{-- <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="payment_terms" id="createPaymentTerms" 
                               class="form-control" 
                               placeholder="E.g., Net 30, COD, etc." readonly>
                    </div> --}}
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-4">
                        <table class="table table-sm mb-0">
                            ...
                            <tr id="createVatRow" style="display: none;">
                                <td class="text-end fw-semibold">VAT ({{ $vatSettings['vat_rate'] ?? 15 }}%):</td>
...
$(function() {
    ...
    function calculateCreateTotals() {
        ...
        const vatInclusive = {{ ($vatSettings['vat_inclusive'] ?? false) ? 'true' : 'false' }};
