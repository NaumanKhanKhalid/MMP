        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="ri-money-dollar-circle-line me-2"></i> Record Supplier Payment
                </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="reference" class="form-control" placeholder="EFT Ref, Cheque #, etc.">
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('supplierId').addEventListener('change', function() {
        ...
        if (balance) {
            document.getElementById('supplierBalance').textContent = `Current Balance: R ${parseFloat(balance).toFixed(2)}`;
        } else {
    ...
    function calculateFees() {
        ...
        document.getElementById('estimatedFees').value = 'R ' + fee.toFixed(2);
        document.getElementById('netAmount').value = 'R ' + net.toFixed(2);
    }

    document.getElementById('paymentMethod').addEventListener('change', calculateFees);
    document.getElementById('grossAmount').addEventListener('input', calculateFees);
...
// Success Modal Function (same as customer)
