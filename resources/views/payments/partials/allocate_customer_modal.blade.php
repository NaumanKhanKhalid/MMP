        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="ri-links-line me-2"></i> Allocate Payment to Invoices
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning">
                    <i class="ri-information-line me-2"></i> No outstanding invoices found for this customer.
                </div>
                @endif
            </div>
            <div class="modal-footer">
                ...
                @if($invoices->count() > 0)
                <button type="button" class="btn btn-primary" id="submitAllocation">
