...
<head>
    ...
    <title>Invoices Export - Excel</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="report-title">Invoices Export Report (Excel Format)</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($invoice->shipping ?? 0, 2) }}</td>
