                                ...
                                <tr class="clickable-row" data-invoice-id="{{ $invoice->id }}" style="cursor: pointer;">
                                    ...
                                    <td class="text-end">
                                        <div class="btn-list">
                                            ...
                                            <!-- Edit (Only if Draft) -->
                                            {{-- @if($invoice->payment_status === 'draft')
                                                <button class="btn btn-sm btn-success-light btn-icon openEditInvoiceModalBtn"
                                            ...
                                            @if($invoice->payment_status === 'draft')
                                                <button class="btn btn-sm btn-danger-light btn-icon" data-bs-toggle="modal"
                                                    data-bs-target="#deleteInvoice{{ $invoice->id }}" title="Delete">
