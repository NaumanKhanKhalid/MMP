            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <div class="form-group">
                    <div class="input-group border">
                        <div class="input-group-text bg-white border-0 pe-0"> <i
                                class="ri-calendar-line lh-1"></i> </div>
                        <input type="text" class="form-control breadcrumb-input border-0 bg-white"
                            id="daterange" placeholder="Search By Date Range">
                    </div>
                </div>
                                        ...
                                        <div class="mb-4">
                                            <span class="avatar avatar-md bg-primary svg-white avatar-rounded">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                    ...
                                                    <rect x="32" y="48" width="192" height="160"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-3 flex-wrap">
                                    ...
                                    <div class="text-end">
                                        <div class="mb-4">
                                            <span
                                                class="avatar avatar-md bg-secondary svg-white avatar-rounded">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                    <rect width="256" height="256" fill="none" />
                                                    <line x1="128" y1="24" x2="128"
                                                        y2="232" fill="none" stroke="currentColor"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="16" />
                                                    <path
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="text-danger fw-semibold"><i
                                            class="ti ti-arrow-narrow-up"></i>3.45%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card custom-card main-card-item">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="javascript:void(0);"
                                        class="text-muted text-decoration-underline fw-medium fs-13">Total page
                                        views</a>
                                    <span class="text-success fw-semibold"><i
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        <div class="p-3 bg-light text-default rounded border border-dashed">
                                            ...
                                            <h5 class="fw-semibold lh-1 mb-0">14,642<span
                                                    class="text-success fw-semibold fs-13 ms-2 d-inline-flex align-items-center">0.64%<i
                                    ...
                                    <div class="col-xl-6">
                                        <div class="p-3 bg-light text-default rounded border border-dashed">
                                            ...
                                            <h5 class="fw-semibold lh-1 mb-0">12,326<span
                                                    class="text-danger fw-semibold fs-13 ms-2 d-inline-flex align-items-center">5.31%<i
                            ...
                            <div class="card-header justify-content-between">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="btn-group btn-group-sm" role="group"
                                        ...
                                        <button type="button"
                                            class="btn btn-primary-light btn-wave">Week</button>
                                        <button type="button"
                                            class="btn btn-primary-light btn-wave">Month</button>
                                        <button type="button"
                                            class="btn btn-primary-light btn-wave">Year</button>
                                    </div>
                                    <div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="lh-1">
                                            ...
                                            <div><span class="text-muted fs-13">Increased by <span
                                                        class="text-success fw-medium ms-1 d-inline-flex align-items-center">0.64%<i
                                                            class="ti ti-trending-up ms-1"></i></span></span>
                                            </div>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="lh-1">
                                            ...
                                            <div><span class="text-muted fs-13">Decreased by <span
                                                        class="text-danger fw-medium ms-1 d-inline-flex align-items-center">2.75%<i
                                                            class="ti ti-trending-down ms-1"></i></span></span>
                                            </div>
                                        </div>
                                        <div class="lh-1 text-end">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="lh-1">
                                            ...
                                            <div><span class="text-muted fs-13">Increased by <span
                                                        class="text-success fw-medium ms-1 d-inline-flex align-items-center">1.54%<i
                                                            class="ti ti-trending-up ms-1"></i></span></span>
                                            </div>
                                        </div>
                                        <div class="lh-1 text-end">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="lh-1">
                                            ...
                                            <div><span class="text-muted fs-13">Decreased by <span
                                                        class="text-danger fw-medium ms-1 d-inline-flex align-items-center">0.12%<i
                                                            class="ti ti-trending-down ms-1"></i></span></span>
                                            </div>
                                        </div>
                                        <div class="lh-1 text-end">
                            ...
                            <li>
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <span class="text-success fw-medium d-block"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <span class="text-danger fw-medium d-block"><i
                            ...
                            <ul class="list-group segmentation-list">
                                <li class="list-group-item male">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div>
                                            <span class="d-block fw-semibold">Male<span
                                                    class="text-success fw-medium ms-1 d-inline-flex align-items-center"><i
                                ...
                                <li class="list-group-item female">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div>
                                            <span class="d-block fw-semibold">Female<span
                                                    class="text-danger fw-medium ms-1 d-inline-flex"><i
                                ...
                                <li class="list-group-item others">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div>
                                            <span class="d-block fw-semibold">Others<span
                                                    class="text-success fw-medium ms-1 d-inline-flex align-items-center"><i
                                ...
                                <li class="list-group-item not-mentioned">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div>
                                            <span class="d-block fw-semibold">Not Mentioned<span
                                                    class="text-success fw-medium ms-1 d-inline-flex align-items-center"><i
                        ...
                        <ul class="list-unstyled recent-activity-list">
                            <li>
                                <div class="d-flex justify-content-between align-items-start gap-2 pe-4">
                                    <div>
                                        <span class="d-block">Jane Smith ordered 5 new units of <span
                                                class="text-primary fw-semibold">Product Y.</span></span>
                                    </div>
                            ...
                            <li>
                                <div class="d-flex justify-content-between align-items-start gap-2 pe-4">
                                    <div>
                                        <span class="d-block">Scheduled demo with potential client DEF for next
                                            Tuesday</span>
                                    </div>
                                    <div class="recent-activity-time fs-13">
                            ...
                            <li>
                                <div class="d-flex justify-content-between align-items-start gap-2 pe-4">
                                    <div>
                                        <span class="d-block">Product X price updated to <span
                                                class="text-success fw-semibold">$XX.XX</span> per every
                                            unit</span>
                                    </div>
                                    <div class="recent-activity-time fs-13">
                            ...
                            <li>
                                <div class="d-flex justify-content-between align-items-start gap-2 pe-4">
                                    <div>
                                        <span class="d-block">Generated <span
                                                class="text-warning fw-semibold">$10,000</span> in
                                            revenue</span>
                                    </div>
                                    <div class="recent-activity-time fs-13">
                            ...
                            <li>
                                <div class="d-flex justify-content-between align-items-start gap-2 pe-4">
                                    <div>
                                        <span class="d-block">Processed refund for Order <span
                                                class="text-danger fw-semibold">#13579</span> due to defective
                                            item</span>
                                    </div>
                                    <div class="recent-activity-time fs-13">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <span class="d-block fw-semibold mb-1">Paypal
                                                        ****2783</span>
                                                    <span class="d-block fs-13 text-muted">Online
                                                        Transaction</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <span class="d-block fw-semibold mb-1">Digital
                                                        Wallet</span>
                                                    <span class="d-block fs-13 text-muted">Online
                                                        Transaction</span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <span class="d-block fw-semibold mb-1">Mastro Card
                                                        ****7893</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <span class="d-block fw-semibold mb-1">Cash On
                                                        Delivery</span>
                                                    <span class="d-block fs-13 text-muted">Pay On
                                                        Delivery</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="border-bottom-0">
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <span class="d-block fw-semibold mb-1">Visa Card
                                                        ****2563</span>
                                                    <span class="d-block fs-13 text-muted">Card Payment</span>
                                                </div>
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-2">
                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);">Classic tufted leather
                                                            sofa</a></p>
                                        ...
                                        <td>
                                            <div class="btn-list">
                                                ...
                                                <button
                                                    class="btn btn-sm btn-icon btn-secondary-light btn-wave">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-2">
                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);">Polaroid Medium
                                                            Camera</a></p>
                                    ...
                                    <tr>
                                        <td class="ps-4 border-bottom-0"><input class="form-check-input"
                                                type="checkbox" id="checkboxNoLabeljob7" value=""
                                                aria-label="..."></td>
                                        <td class="border-bottom-0">
                                            <div class="d-flex">
                                                <span class="avatar avatar-md bg-light"><img
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            ...
                                            <span class="d-block fw-semibold d-inline-flex">Chrome<span
                                                    class="text-muted fs-13 ms-1">(Google LLC)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-success me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">Edge<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(Microsoft
                                                    Corp)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-danger me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">Firefox<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(Mozilla
                                                    Corp)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-success me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">Safari<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(Apple
                                                    Inc)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-success me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">UCBrowser<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(UCWeb)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-success me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">Opera<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(Opera Software
                                                    AS)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-danger me-2 fs-13 fw-medium d-inline-flex"><i
                            ...
                            <li>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="flex-fill">
                                        <div
                                            class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                            <span class="d-block fw-semibold d-inline-flex">Samsung
                                                Internet<span
                                                    class="text-muted fs-13 ms-1 fw-normal">(Samsung)</span></span>
                                            <span class="d-block h6 mb-0 fw-semibold"><span
                                                    class="text-success me-2 fs-13 fw-medium d-inline-flex"><i
