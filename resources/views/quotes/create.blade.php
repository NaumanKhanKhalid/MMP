                    ...
                    <form action="{{ route('quotes.store') }}" method="POST" id="quoteForm">
                        ...
                        <div id="vehicleSection" class="row mb-4" style="display: none;">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="vehicleSelect" name="vehicle_id" onchange="selectVehicle()">
                                        <option value="">Select Vehicle</option>
                                    </select>
                                    <button type="button" class="btn btn-success" onclick="showAddVehicleModal()" title="Add Vehicle">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label class="form-label fw-bold"><i class="ri-shopping-cart-line me-1"></i>Products & Services</label>
                                <div class="alert alert-warning">
                                    <i class="ri-information-line me-2"></i>
                                    <strong>Note:</strong> Use the POS system to create quotes with full product selection. 
            ...
            <form id="addVehicleForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="newVehicleEngine" placeholder="e.g., 2.0L Turbo">
                    </div>
                    <div class="mb-3">
...
$('#customerSearch').on('input', function() {
    ...
    $.get("{{ route('api.customers.search') }}", { q: query }, function(customers) {
        if (customers.length > 0) {
            ...
            $('#customerSearchResults').html('<div class="p-3 text-center text-muted">No customers found</div>').show();
        }
    });
});
