                            ...
                            <div class="col-6 mb-2">
                                ...
                                <select name="vehicle_make_id" id="vehicleMakeSelect"
                                    ...
                                    @foreach ($makes as $make)
                                        <option value="{{ $make->id }}" data-name="{{ $make->name }}">
                                            {{ $make->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6 mb-2">
                                ...
                                <select name="vehicle_model_id" id="vehicleModelSelect"
                                    ...
                                    @foreach ($models as $model)
                                        <option value="{{ $model->id }}" data-name="{{ $model->name }}"
                                            data-make-id="{{ $model->make_id }}">{{ $model->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6 mb-2">
                                ...
                                <select name="vehicle_engine_id" id="vehicleEngineSelect"
                                    ...
                                    @foreach ($engines as $engine)
                                        <option value="{{ $engine->id }}" data-code="{{ $engine->code }}">
                                            {{ $engine->code }}</option>
                                    @endforeach
                                </select>
                            </div>
