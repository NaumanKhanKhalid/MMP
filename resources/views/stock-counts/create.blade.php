            ...
            <div class="card custom-card">
                ...
                <form id="createStockCountForm">
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ route('stock-counts.index') }}" class="btn btn-light me-2">
...
document.getElementById('createStockCountForm').addEventListener('submit', function(e) {
    ...
    const url = '{{ route("stock-counts.store") }}';
    ...
    .then(data => {
        if (data.success) {
            alert(data.message);
            const url = '{{ route("stock-counts.count", ":id") }}'.replace(':id', data.count_id);
