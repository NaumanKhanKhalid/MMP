...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <h4 class="page-title fw-semibold fs-18 mb-0">Debtors Ageing Report</h4>
            <p class="fs-13 text-muted mb-0">As at {{ date('d M Y', strtotime($asAt)) }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('reports.debtors-ageing', ['as_at' => $asAt, 'export' => 'pdf']) }}" class="btn btn-danger btn-sm">
                <i class="ri-file-pdf-line me-1"></i> Export PDF
            </a>
            <a href="{{ route('reports.debtors-ageing', ['as_at' => $asAt, 'export' => 'csv']) }}" class="btn btn-success btn-sm">
    ...
    <div class="card custom-card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('reports.debtors-ageing') }}">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        ...
                        <div class="col border-start">
                            ...
                            <h3 class="mb-0 text-primary">R {{ number_format($totals['total'], 2) }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <br><small class="text-muted">{{ $data['customer']->customer_code }}</small>
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                ...
                                <p class="text-muted mt-2">No outstanding customer balances</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
